        ...
        <div className="relative">
          <div className="flex items-center justify-center space-x-4 transition-transform duration-300">
            {cards.slice(currentIndex, currentIndex + 4).map((card, index) => (
              <div
                className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 transition-transform duration-300 hover:scale-105"
                key={index}
              >
                <a href="#">
                  <img
