    ...
    <main className="max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
        ...
        >
          ...
          >
            Cuối cùng, bạn sẽ chọn cài đặt đặt phòng, thiết lập giá và đăng mục
            cho thuê.
          </motion.div>
        </motion.div>
        ...
        >
          ...
          >
            <video
              ...
              preload="auto"
            >
              <source src="https://stream.media.muscache.com/KeNKUpa01dRaT5g00SSBV95FqXYkqf01DJdzn01F1aT00vCI.mp4?v_q=high"></source>
            </video>
          </motion.div>
